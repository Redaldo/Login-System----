...
if(isset($_POST['email']) && isset($_POST['passwort'])) {
	...
	if ($user !== false && password_verify($passwort, $user['passwort'])) {
		...
		$error_msg =  "E-mail or password was invalid<br><br>";
	}
...
?>
	...
	<div class="checkbox">
	  <label>
		<input type="checkbox" value="remember-me" name="angemeldet_bleiben" value="1" checked> Remember Me
	  </label>
	</div>
	<button class="btn btn-lg btn-primary btn-block" type="submit">Login</button>
	<br>
	<a href="passwortvergessen.php">Password Forgotten</a>
  </form>
